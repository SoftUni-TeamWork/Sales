...
IF OBJECT_ID('Sales') IS NOT NULL
  DROP TABLE Sales
IF OBJECT_ID('Supermarkets') IS NOT NULL
  DROP TABLE Supermarkets
IF OBJECT_ID('Products') IS NOT NULL
  DROP TABLE Products
IF OBJECT_ID('Vendors') IS NOT NULL
  DROP TABLE Vendors
IF OBJECT_ID('MeasurementUnits') IS NOT NULL
...
INSERT MeasurementUnits(Id, Name) VALUES
(1,'liter'),
(2,'kilograms'),
(3,'packs')
...
INSERT Products(Id, Name, VendorId, MeasurementUnitId, Price) VALUES
(1,'Chai',1,3,18),
(2,'Chang',1,1,19),
...
INSERT Sales(Id, SaledOn, SupermarketId, ProductId, Quantity) VALUES
...
ALTER TABLE Products WITH CHECK ADD CONSTRAINT FK_Products_MeasurementUnits
FOREIGN KEY(MeasurementUnitId) REFERENCES MeasurementUnits (Id)
GO

ALTER TABLE Products WITH CHECK ADD CONSTRAINT FK_Products_Vendors
FOREIGN KEY(VendorId) REFERENCES Vendors (Id)
GO

ALTER TABLE Sales WITH CHECK ADD CONSTRAINT FK_Sales_Products
FOREIGN KEY(ProductId) REFERENCES Products (Id)
GO

ALTER TABLE Sales WITH CHECK ADD CONSTRAINT FK_Sales_Supermarkets 
